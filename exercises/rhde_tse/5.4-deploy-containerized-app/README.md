...
In this exercise, we'll create a job template for our playbook and run our automation to build an edge image.

This exercise will cover:

* Syncing our project in controller
* Creating a job template
* Building an image via Ansible automation
